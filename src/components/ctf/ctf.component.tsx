        ...
        <div className="container">
            <section id="main-content" className="about">
                <div className="hero-container">
                    ...
                    <img src="/assets/img/ctf/CTF-2026-poster.png" alt="Floor Debugging" style={{maxHeight: "80vh"}}></img>
                </div>
            ...
            <section id="faq">
                <div className="section-title">
                    ...
                    <div className="faq-item">
                        <h4><strong>What can I do for food?</strong></h4>
                        <p>We’ll have a hot lunch and some other treats, with both meat, vegetarian and gluten free options available.<br />
                            There is a Tesco and a Centra open nearby, alongside lots of other food outlets if something else takes your fancy.</p>
                    </div>
