                ...
                <div className="flex flex-col gap-8 md:gap-12">
                    <div className="flex flex-col gap-2 md:gap-3">
                        ...
                        <p className="text-base text-muted-foreground font-normal leading-7 sm:leading-relaxed tracking-wide">
                            ...
                            number of services on our Society run servers for our members. CompSoc
                            is the oldest computer-related society in Ireland, while many Alumni
                            believe it was much earlier, was formally established in 1977 during the
                            days that the University was known as UCG.
                        </p>
                    </div>
                    <div className="flex flex-col gap-2 md:gap-3">
                        <h2 className="text-xl sm:text-2xl text-secondary-foreground font-bold relative mb-1 text-left">
                        ...
                        <p className="text-base text-muted-foreground font-normal leading-7 sm:leading-relaxed tracking-wide">
                            ...
                            Linux, hardware and programming. As outlined under our Constitution, our
                            aims is to "promote and increase awareness of electronic communication
                            and related computer systems, a forum to discuss and gain experience in
                            computer networking and systems and to help educate people in the usage
                    ...
                    <div className="flex flex-col gap-2 md:gap-3">
                        ...
                        <p className="text-base text-muted-foreground font-normal leading-7 sm:leading-relaxed tracking-wide">
                            ...
                            <i>"University Societies Coordination Group"</i>) on 27th May, 2022.
                        </p>
                    </div>
                </div>
            </div>
