...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Meet the Committee - CompSoc - NUI Galway's Computer Society</title>
    ...
    <div class="d-flex flex-column">
        ...
        <nav class="nav-menu">
            <ul>
                ...
                <li><a href="https://my.compsoc.ie/" target="_blank"><i class="bx bx-log-in"></i> Account Self Service
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-3 mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <img src="/assets/img/committee/2021-22/ciaranmccarthy.jpg" alt="wrapkit"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <div class="pt-2">
                                            ...
                                            <p>
                                            <div class="text-left">Conor is in 4th year Computer Science. Having had grown up on a rural Co. Mayo farm, everyone's unsure how he managed to get this far. Some say he can even type without looking at the keyboard. Mayo4Sam.</div>
                                            </p>
                                            <ul class="list-inline">
                            ...
                            <div class="col-lg-3 mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <img src="/assets/img/committee/2021-22/davidkong.jpg" alt="wrapkit"
                                            class="img-fluid rounded-circle"/>
                                    </div>
                                    <div class="col-md-12 text-center">
                                        <div class="pt-2">
                                            ...
                                            <h6 class="subtitle mb-3">System Administrator</h6>
                                            <p>
                                            <div class="text-left">Second year Computer Engineering student interested in computer hardware and IoT. Hobbies in music, gaming and 3D printing.</div>
                                            </p>
                                            <ul class="list-inline">
                            ...
                            <div class="col-lg-3 mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <img src="/assets/img/committee/2021-22/ciaragalvin.jpg" alt="wrapkit"
                                            class="img-fluid rounded-circle"/>
                                    </div>
                                    <div class="col-md-12 text-center">
                                        <div class="pt-2">
                                            ...
                                            <p>
                                            <div class="text-left">Ciara is in 4th of year computer science & IT | Drinks 10 cups of tea a day | Up the Kingdom</div>
                                            </p>
                                            <ul class="list-inline">
                            ...
                            <div class="col-lg-3 mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <img src="/assets/img/committee/2021-22/ruaidhrimadden.jpg" alt="wrapkit"
                                            class="img-fluid rounded-circle"/>
                                    </div>
                                    <div class="col-md-12 text-center">
                                        <div class="pt-2">
                                            ...
                                            <h6 class="subtitle mb-3">Ordinary Committee Member</h6>
                                            <p>
                                            <div class="text-left">This is Ruaidhrí, he is doing Electrical Engineering in First Year. Don't worry, he's not sure how to pronounce his name either, and at this point he's too scared to ask.</div>
                                            </p>
                                            <ul class="list-inline">
                            ...
                            <div class="col-lg-3 mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <img src="/assets/img/committee/2021-22/aoifeoloughlin.jpg" alt="wrapkit"
                                            class="img-fluid rounded-circle"/>
                                    </div>
                                    <div class="col-md-12 text-center">
                                        <div class="pt-2">
                                            ...
                                            <h6 class="subtitle mb-3">Ordinary Committee Member</h6>
                                            <p>
                                            <div class="text-left">Hi! I'm Aoife and an OCM! I'm a fourth year CS and IT student. I joined CompSoc because why not? And you'll mostly likely find me in the CompSoc Minecraft server building hogwarts :)</div>
                                            </p>
                                            <ul class="list-inline">
